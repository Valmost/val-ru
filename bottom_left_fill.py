...
if __name__=='__main__':
    from tools.pdf import pdf_input, extract_shapes
    # index from 0-15
    path = 'C:/Users/Иван/Documents/low_poly1.pdf'
    ...
    bfl=BottomLeftFill(220,polys,vertical=False,NFPAssistant=nfp_ass)
